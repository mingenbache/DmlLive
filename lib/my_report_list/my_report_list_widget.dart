    ...
    return StreamBuilder<List<BookingsRecord>>(
      stream: queryBookingsRecord(
        queryBuilder: (bookingsRecord) => bookingsRecord
            ...
            .where('bookingstatus', isEqualTo: 'complete'),
      ),
      builder: (context, snapshot) {
        ...
        List<BookingsRecord> myReportListBookingsRecordList = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
            ...
            children: [
              ...
              Expanded(
                child: Padding(
                  ...
                  child: Builder(
                    builder: (context) {
                      final myCompletedbookings =
                          myReportListBookingsRecordList?.toList() ?? [];
                      return SingleChildScrollView(
                        child: Column(
                          mainAxisSize: MainAxisSize.min,
                          mainAxisAlignment: MainAxisAlignment.start,
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: List.generate(myCompletedbookings.length,
                              (myCompletedbookingsIndex) {
                            final myCompletedbookingsItem =
                                myCompletedbookings[myCompletedbookingsIndex];
                            return Padding(
                              padding:
