                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return Padding(
                                                                        ...
                                                                        child:
                                                                            AddDoctorFormWidget(
                                                                          docNames:
                                                                              bookingConfirmationBookingsRecord.docNames,
                                                                          docEmail:
                                                                              bookingConfirmationBookingsRecord.doctorEmail,
                                                                          docPhone:
                                                                              bookingConfirmationBookingsRecord.doctorPhoneNumber,
                                                                        ),
                                                                      );
                                                                    },
                                                                  ).then((value) =>
                                                                    ...
                                                                    itemBuilder:
                                                                      ...
                                                                      return Padding(
                                                                        ...
                                                                        child: StreamBuilder<
                                                                            TestPackagesRecord>(
                                                                          stream:
                                                                              TestPackagesRecord.getDocument(packagesListItem),
                                                                          builder:
                                                                              (context, snapshot) {
                                                                            // Customize what your widget looks like when it's loading.
                                                                            if (!snapshot.hasData) {
                                                                  ...
                                                                  itemBuilder:
                                                                    ...
                                                                    return Padding(
                                                                      ...
                                                                      child: StreamBuilder<
                                                                          TestsRecord>(
                                                                        stream:
                                                                            TestsRecord.getDocument(testsListItem),
                                                                        builder:
                                                                            (context,
                                                                                snapshot) {
                                                                          // Customize what your widget looks like when it's loading.
