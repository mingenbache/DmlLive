                                                                        ...
                                                                        children: [
                                                                          Text(
                                                                            valueOrDefault<String>(
                                                                              newBookingBookingsRecord.specialTests!.toList().length.toString(),
                                                                              '0',
                                                                            ),
                                                                            textAlign:
                                                                                TextAlign.center,
                                                            ...
                                                            Expanded(
                                                              child: Padding(
                                                                ...
                                                                child: Builder(
                                                                  builder:
                                                                      (context) {
                                                                    final specialtestsList = newBookingBookingsRecord
                                                                        .specialTests!
                                                                        .toList()
                                                                        .map((e) =>
                                                                            e)
                                                            ...
                                                            return AlertDialog(
                                                              ...
                                                              content: Text(
                                                                ...
                                                                locale: FFLocalizations.of(
                                                                        context)
                                                                    .languageCode,
                                                              )} with  ${newBookingBookingsRecord.testsIncluded!.toList().length.toString()} tests and ${newBookingBookingsRecord.testPackages!.toList().length.toString()} test packages.'),
                                                              actions: [
                                                                TextButton(
                                                                  onPressed: () =>
                                                                      Navigator.pop(
