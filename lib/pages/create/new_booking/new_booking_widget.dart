  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (FFAppState().selectedDate != null) {
        if (currentUserDocument!.currentBooking != null) {
          _model.currentBookingDocument = await actions.getBookingDocument(
            currentUserDocument!.currentBooking!,
          );
          setState(() {
            _model.booking = _model.currentBookingDocument;
          });
        }
      } else {
        setState(() {
        ...
        if (currentUserDocument!.currentBooking != null) {
          _model.currentBookingDocument2 = await actions.getBookingDocument(
            currentUserDocument!.currentBooking!,
          );
          setState(() {
            _model.booking = _model.currentBookingDocument2;
          });
        }
      }
    });
    ...
    _model.firstNameController ??=
        TextEditingController(text: _model.booking!.firstname);
    _model.lastNameController ??=
        TextEditingController(text: _model.booking!.lastname);
    _model.emailAddressController ??=
        TextEditingController(text: _model.booking!.emailaddress);
    _model.phoneNumberController ??=
        TextEditingController(text: _model.booking!.phonenumber);
    _model.diagnosisController ??=
        TextEditingController(text: _model.booking!.diagnosis);
    _model.refDoctorController ??=
        TextEditingController(text: '${_model.booking!.docNameAddress}');
    setupAnimations(
                                  ...
                                  child: SingleChildScrollView(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Stack(
                                          children: [
                                            if (_model.booking!.specialTests!
                                                    .toList()
                                                    .length >
                                                0)
                                              Padding(
