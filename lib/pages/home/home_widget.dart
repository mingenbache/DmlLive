                                                                  ...
                                                                  builder: (context) =>
                                                                    ...
                                                                    stream:
                                                                      ...
                                                                      queryBuilder: (chatsRecord) => chatsRecord
                                                                          ...
                                                                          .where(
                                                                              'last_message_time',
                                                                              isGreaterThan: currentUserDocument!.lastLogin),
                                                                      singleRecord:
                                                                          true,
                                                                    ),
                                                                    builder:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            stream:
                                                                              ...
                                                                              queryBuilder: (bookedTestsRecord) => bookedTestsRecord.where('user', isEqualTo: currentUserReference),
                                                                            ),
                                                                            builder:
                                                                                (context, snapshot) {
                                                                              // Customize what your widget looks like when it's loading.
                                                                              ...
                                                                              return AutoSizeText(
                                                                                functions.checkNewTests(textBookedTestsRecordList.toList()).toString(),
                                                                ...
                                                                children: [
                                                                  Container(
                                                                    ...
                                                                    child: StreamBuilder<
                                                                      ...
                                                                      stream:
                                                                          queryInvoicesRecord(
                                                                        queryBuilder: (invoicesRecord) => invoicesRecord.where('user', isEqualTo: currentUserReference).where(
                                                                            'is_paid',
                                                                            isNotEqualTo:
                                                                                true),
                                                                      ),
