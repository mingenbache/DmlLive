...
import 'user_list2_model.dart';
export 'user_list2_model.dart';
                                                                ...
                                                                return Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      key: Key(
                                                                          'Keyk3c_${clientsIndex}_of_${clients.length}'),
                                                                      index: functions
                                                                          .add1(
                                                                              clientsIndex),
                                                                      userRecord:
                                                              ...
                                                              itemBuilder:
                                                                ...
                                                                return Container(
                                                                  ...
                                                                  child:
                                                                      StaffUserCardWidget(
                                                                    key: Key(
                                                                        'Key1qr_${staffIndex}_of_${staff.length}'),
                                                                    index:
                                                                        staffIndex,
                                                                    userRecord:
                                                                        staffItem,
