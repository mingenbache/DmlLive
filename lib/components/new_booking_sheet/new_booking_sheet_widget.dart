...
import 'new_booking_sheet_model.dart';
export 'new_booking_sheet_model.dart';
...
class _NewBookingSheetWidgetState extends State<NewBookingSheetWidget>
  ...
  late NewBookingSheetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NewBookingSheetModel());

    _model.doctorNamesController ??= TextEditingController();
    _model.docemailAddressController ??= TextEditingController();
    _model.docphoneNumberController ??= TextEditingController();
    setupAnimations(
                                        ...
                                        Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: TextFormField(
                                              ...
                                              validator: _model
                                                  .doctorNamesControllerValidator
                                                  .asValidator(context),
                                            ...
                                            children: [
                                              Expanded(
                                                child: TextFormField(
                                                  ...
                                                  validator: _model
                                                      .docemailAddressControllerValidator
                                                      .asValidator(context),
                                                ),
                                              ),
                                            ],
                                            ...
                                            children: [
                                              Expanded(
                                                child: TextFormField(
                                                  ...
                                                  validator: _model
                                                      .docphoneNumberControllerValidator
                                                      .asValidator(context),
                                                ),
                                              ),
                                            ],
                          ...
                          onPressed: () async {
                            final bookingsCreateData = {
                              ...createBookingsRecordData(
                                ...
                                totalPrice: 0,
                                totalTests: 0,
                                userPatient: _model.isPatientValue,
                                ...
                                docNames: _model.doctorNamesController.text,
                                doctorPhoneNumber:
                                    _model.docphoneNumberController.text,
                                doctorEmail:
                                    _model.docemailAddressController.text,
                              ),
                              'form_images': _model.uploadedFileUrls
                                  .map((e) => e)
                                  .toList(),
                            };
                            ...
                            _model.newbookingRef =
                                BookingsRecord.getDocumentFromData(
                                    bookingsCreateData,
                                    bookingsRecordReference);
                            FFAppState().update(() {
                              FFAppState().isPatient = _model.isPatientValue!;
                            });
                            if (_model.isPatientValue!) {
                              ...
                              await _model.newbookingRef!.reference
                            ...
                            final usersUpdateData = createUsersRecordData(
                              currentBooking: _model.newbookingRef!.reference,
                            ...
                            context.goNamed(
                              ...
                              queryParams: {
                                'bookingRef': serializeParam(
                                  _model.newbookingRef!.reference,
