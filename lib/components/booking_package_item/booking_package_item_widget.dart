...
import 'booking_package_item_model.dart';
export 'booking_package_item_model.dart';
...
class _BookingPackageItemWidgetState extends State<BookingPackageItemWidget>
  ...
  late BookingPackageItemModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BookingPackageItemModel());
