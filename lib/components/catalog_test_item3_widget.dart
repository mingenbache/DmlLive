...
class CatalogTestItem3Widget extends StatefulWidget {
  const CatalogTestItem3Widget({
    Key key,
    this.test,
    this.index,
    this.listSize,
  ...
  @override
  _CatalogTestItem3WidgetState createState() => _CatalogTestItem3WidgetState();
}

class _CatalogTestItem3WidgetState extends State<CatalogTestItem3Widget> {
  @override
