                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child: StreamBuilder<
                                                                        ...
                                                                        stream:
                                                                          ...
                                                                          queryBuilder: (testedTestsRecord) => testedTestsRecord.where('booking_ref', isEqualTo: widget.booking.reference).where(
                                                                              'is_verified',
                                                                              isEqualTo: true),
                                                                        ),
                                                                        builder:
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child: Theme(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onChanged: (newValue) =>
                                                                        setState(() =>
                                                                            checkboxListTileValueMap1[reportVerifiedTestsItem] =
                                                                                newValue),
                                                                    title: Text(
                                                                      functions.checkNullString(
                                                                          functions
                                                                              .returnTestName(containerTestedTestsRecord.testRef)),
                                                                      style: FlutterFlowTheme.of(
                                                                              context)
                                                                          .title3
                                                                          .override(
