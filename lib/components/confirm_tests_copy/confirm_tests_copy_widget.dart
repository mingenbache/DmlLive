                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        Builder(
                                                                          builder:
                                                                              (context) {
                                                                            final packageTests =
                                                                                testPackageCardTestPackagesRecord.testsIncluded!.toList();
                                                                            return ListView.builder(
                                                                                        ...
                                                                                        if (testPackItemBookedTestsRecord != null) {
                                                                                          ...
                                                                                          if (confirmDialogResponse) {
                                                                                            ...
                                                                                            final bookingsUpdateData1 = {
                                                                                              'bookedTests': FieldValue.arrayRemove([
                                                                                                packageTestsItem
                                                                                              ]),
                                                                                            };
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                                      ...
                                                                                      child: Row(
                                                                                        ...
                                                                                        children: [
                                                                                          Expanded(
                                                                                            flex: 2,
                                                                                            child: Text(
                                                                                              containerTestPackagesRecord.packageName!,
                                                                              ...
                                                                              Container(
                                                                                ...
                                                                                child: Builder(
                                                                                  builder: (context) {
                                                                                    final testPackTests = containerTestPackagesRecord.testsIncluded!.toList();
                                                                                    return ListView.builder(
                                                                                      padding: EdgeInsets.zero,
                                                                                      primary: false,
                                                                                      shrinkWrap: true,
                                                                                      scrollDirection: Axis.vertical,
                                                                                      itemCount: testPackTests.length,
                                                                                      itemBuilder: (context, testPackTestsIndex) {
                                                                                        final testPackTestsItem = testPackTests[testPackTestsIndex];
                                                                                        return Padding(
                                                                                          padding: EdgeInsetsDirectional.fromSTEB(4.0, 0.0, 4.0, 4.0),
                                                                                          child: StreamBuilder<TestsRecord>(
                                                                                            stream: TestsRecord.getDocument(testPackTestsItem),
                                                                                            builder: (context, snapshot) {
                                                                                              // Customize what your widget looks like when it's loading.
                                                                                              if (!snapshot.hasData) {
                                                                                                return Center(
                                                                                              ...
                                                                                              return InkWell(
                                                                                                onTap: () async {
                                                                                                  ...
                                                                                                  final bookingsUpdateData = {
                                                                                                    'bookedTests': FieldValue.arrayUnion([testPackTestsItem]),
                                                                                                  };
                                                                                                  ...
                                                                                                  var bookedTestsRecordReference = BookedTestsRecord.collection.doc();
                                                                                                  await bookedTestsRecordReference.set(bookedTestsCreateData);
                                                                                                  _model.newBookedTest = BookedTestsRecord.getDocumentFromData(bookedTestsCreateData, bookedTestsRecordReference);
                                                                                                    ...
                                                                                                    builder: (context) {
                                                                                                      return Padding(
                                                                                                        ...
                                                                                                        child: ChooseTechnologistWidget(
                                                                                                          ...
                                                                                                          bookingRef: widget.booking,
                                                                                                          scheduledDate: confirmTestsSheetBookingsRecord.scheduledDate,
                                                                                                          bookedTest: _model.newBookedTest,
                                                                                                        ),
                                                                                                      );
                                                                                                    },
                                                                                                  ).then((value) => setState(() {}));
                                                                    ...
                                                                    onTap:
                                                                      ...
                                                                      if (specialTestsCardSpecialTestsRecord !=
                                                                        ...
                                                                        if (confirmDialogResponse) {
                                                                          ...
                                                                          await specialTestsCardSpecialTestsRecord!
                                                                              .reference
                                                                              .delete();
                                                                        }
                                                                      } else {
